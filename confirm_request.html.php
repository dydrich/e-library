        ...
        <div id="content" style="order: 2">
            <div id="confirm_form" class="mdc-elevation--z2 ">
                <div style="width: 100%; display: flex; align-items: center; align-content: center; border-radius: 3px 3px 0 0; margin-top: 15px">
                    <p class="material_label _bold" style="color: var(--mdc-theme-primary); font-size: 1.5em; width: 100%; text-align: center">Conferma richiesta di accesso</p>
                </div>
                <div style="width: 100%; align-items: left; align-content: center; border-radius: 3px 3px 0 0; margin-top: 15px">
                    <p>Stai richiedendo l'attivazione del servizio con i dati che seguono:</p>
                    <p style="margin-top: 20px">
                        Studente: <span style="font-weight: bold"><?php echo $_user['firstname']." ".$_user['lastname'] ?></span>
                    </p>
                    <p>
