                ...
                <form method="post" id="bookform"  class="userform mdc-elevation--z3" style="width: 80%; text-align: center; margin: auto; padding: 20px; ">
                    <fieldset style="width: 90%; margin: auto; padding-top: 10px; padding-bottom: 20px; padding-left: 30px; padding-right: 30px">
                        ...
                        <div class="form_row">
                            ...
                            <select class="mdc-select" name="room" id="room" style="width: 100%; margin: auto; grid-row: 1; grid-column: 2/3">
                                <?php
                        ...
                        <div class="form_row">
                            <p class="material_label" style="text-align: left; grid-row: 2; grid-column: 1/2">Libreria</p>
                            <select class="mdc-select" name="bookcase" id="bookcase" style="width: 100%; margin-right: auto; margin-left: auto; grid-row: 2; grid-column: 2/3">
                                <?php
                    ...
                    <fieldset style="width: 90%; margin-right: auto; margin-left: auto; margin-top: 20px; padding-top: 10px; padding-bottom: 20px">
                        ...
                        <div class="form_row">
                            <p class="material_label" style="text-align: left; grid-row: 4; grid-column: 1/2">Titolo</p>
                        ...
                        <div class="form_row">
                            <p class="material_label" style="text-align: left; grid-row: 5; grid-column: 1/2">Autore</p>
