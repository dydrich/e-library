...
var j_alert = function(type, msg){
    var mtop = mleft = 0;
    mtop = (window.innerHeight - 300) / 2;
    mleft = (window.innerWidth - 500) / 2;
    console.log("top==>"+mtop+" su altezza screen="+screen.height+" e H browser="+window.innerHeight);
    console.log("left==>"+mleft+" su larghezza screen="+screen.width+" e L browser="+window.innerWidth);
    if (type === "alert") {
        ...
        //infomessage.style.width = "500px";
        //infomessage.style.height = "300px";
        var _text = '';
        if (field === 'user') {
        ...
        document.getElementById("close_button").addEventListener('click', function (ev) {
            window.setTimeout(function () {
